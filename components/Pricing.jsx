    ...
    >
      <Container>
        ...
        <Plan
            name="Free"
            price="$0"
            description="Try us out and see the value for yourself."
            href="/register"
            features={[
              'Upload unlimited content',
              'Make endless edits',
              'Use everything in our template library',
              'Add subtitles your edits'
            ]}
          />
          <Plan
            featured
          ...
          <Plan
            name="Enterprise"
            price="Contact Us"
            description="For agencies and marketing powerhouses."
            href="/register"
            features={[
            ]}
          />
